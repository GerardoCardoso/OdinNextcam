...
<head>
  ...
  <title>Unidades | NextAdmin</title>
...
?>     
        ...
        <ul class="nav nav-treeview">
              ...
              <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="unidades.php" class="nav-link active ">
...
for ($i=0; $i < $cuentas ; $i++) { 
$sql1="SELECT nombre FROM unidad";
    $res1 = mysqli_query($con,$sql1);
    while($row1=mysqli_fetch_array($res1)){
      $nombres[]=$row1['nombre'];
    };
    $sql2="SELECT descripcion FROM unidad";
    $res2 = mysqli_query($con,$sql2);
    while($row2=mysqli_fetch_array($res2)){
      $foto[]=$row2['descripcion'];
    };
  $sql2="SELECT abreviatura FROM unidad";
    $res2 = mysqli_query($con,$sql2);
    while($row2=mysqli_fetch_array($res2)){
      $abreviatura[]=$row2['abreviatura'];
    };
  $sql2="SELECT tiposat FROM unidad";
    $res2 = mysqli_query($con,$sql2);
    while($row2=mysqli_fetch_array($res2)){
      $tiposat[]=$row2['tiposat'];
    };
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Creción de Unidad</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card-body">
              <form action="altaunidades.php" method="post">
                <div class="form-row">
                  ...
                  <div class="form-group  col-md-6">
                    ...
                    <input type="text" class="form-control" id="abreviatura" name="abreviatura" placeholder="Introducir descripcion" required>
                  </div>
                    <div class="form-group  col-md-6">
                    <label for="tiposat">SAT</label>
                    <input type="text" class="form-control" id="tiposat" name="tiposat" placeholder="Introducir descripcion" required>
                  </div>
                </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php  for ($i=0; $i <$cuentas; $i++) { 
                          ...
                          echo '<td>'.$foto[$i].'</td>';
                          echo '<td>'.$abreviatura[$i].'</td>';
                          echo '<td>'.$tiposat[$i].'</td>';
                          echo '</tr>';
                          } ?>
                  </tbody>
