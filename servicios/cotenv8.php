...
$pdf->Cell(59.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(17.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(71.2,6,utf8_decode('Lic. Arturo Nextle Paredes'),0,1,'L');
$pdf->Cell(59.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(17.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(71.2,6,utf8_decode('Contacto: gerencia@nextcam.com.mx'),0,1,'L');
$pdf->Cell(59.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(17.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(71.2,6,utf8_decode('Precios sujetos a cambios sin previo aviso'),0,1,'L');
$pdf->Cell(59.2,6,utf8_decode(''),0,0,'C');
$pdf->Cell(17.2,6,utf8_decode(''),0,0,'C');
...
// enviando
if($mail->Send()){
 echo "<script type=\"text/javascript\">alert(\"Correo enviado correctamente\");window.location = 'enviodecotizacion.php';</script>";
}else{
 echo "<script type=\"text/javascript\">alert(\"Hubo un error al enviar el correo al destino marcado\");window.location = 'enviodecotizacion.php';</script>";
}
