...
$sq = "INSERT INTO cotizacion (cliente, fecha, condpago, validez, tiempoentrega, nota, descuento, total, useralta, subtotal, anticipo, iva, btniva, btndescuento, btnanticipo, correo) VALUES ('$cliente', '$fecha', '$condpago', '$validez', '$tiempoen', '$nota', '$des', '$total', '$token', '$sub','$anticipo','$iva','$btniva','$btndescuento','$btnanticipo','$correo')";
...
elseif(!empty($btnanticipo)){
       ...
       echo "<script type=\"text/javascript\">alert(\"Datos guardados correctamente\");window.location = 'cotizacionvxi.php';</script>";


}else{
    echo "<script type=\"text/javascript\">alert(\"Datos guardados correctamente\");window.location = 'cotizacionvi.php';</script>";}  
