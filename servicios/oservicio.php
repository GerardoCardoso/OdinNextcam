        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
              <form action="altaorden.php" method="post" enctype="multipart/form-data" onsubmit="move()">
                 <div class="row">
     ...
     $token = strtok($nom[1], " "); 
          ?>
                    ...
                    <option value="">Seleccione:</option>
                      ...
                      <option value="Instalacion">Configuración</option>
...
<div class="form-group col-md-4">
                   ...
                   <div class="form-group col-md-4">
                     ...
                     <a class="btn btn-primary btn-xs" href="../signature/docs/" target="_blank" type="button"><i class="nav-icon fas fa-plus-circle"></i></a>
                       <input type="file" class="form-control-file" id="firma" name="firma" accept="image/*" required />
                  </div>
   <div class="form-group col-md-4">
                      <label for="telefono">Evidencia (Subir máximo 9 fotos)</label>
                       <input type="file" class="form-control-file" id="archivo[]" name="archivo[]" accept="image/*" multiple="" required >  
                  </div>
   <div class="form-group col-md-12">
  <div class="progress">
  <div class="progress-bar" role="progressbar" name="myBar" id="myBar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"> </div>
