...
error_reporting(0);
 ...
 if(isset($_POST["boton2"])) {
  ...
  $rfc = $_POST["rfc"];
  $nfacturacion = $_POST["nfacturacion"];
...
if ($nempresa==NULL && $rfc==NULL && $nfacturacion==NULL) {
  ...
  $nfacturacion="-";
   ...
   $sql = "INSERT INTO clientes (nombre, appaterno, amaterno, tipofom, titulo, nempresa, rfc, nfacturacion, celular, telefono, mail, direccion, numero, colonia, ciudad, municipio, estado, fecalta) VALUES ('$nombre', '$apaterno', '$amaterno', '$tipofom', '$titulo', '$nempresa', '$rfc', '$nfacturacion', '$celular', '$telefono', '$email', '$direccion', '$numero', '$colonia', '$ciudad', '$municipio', '$estado', '$fecalta')";
if (mysqli_query($con, $sql)) {
      echo "<script type=\"text/javascript\">alert(\"Datos guardados correctamente\");window.location = 'clientes.php';</script>";
    } else {
