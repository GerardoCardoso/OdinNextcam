...
for ($i=0; $i < $cuentas ; $i++) { 
$sql1="SELECT nombre FROM marcas";
    $res1 = mysqli_query($con,$sql1);
    while($row1=mysqli_fetch_array($res1)){
      $nombres[]=$row1['nombre'];
    };
    $sql2="SELECT foto FROM marcas";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Creciónde Marca</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card-body">
              <form action="altamarca.php" method="post">
                <div class="form-row">
                  ...
                  <div class="form-group  col-md-6">
                    ...
                    <input type="text" class="form-control" id="foto" name="foto" placeholder="Introducir URL" required>
                  </div>
                </div>
