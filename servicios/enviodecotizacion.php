...
<head>
  ...
  <title>Envio de Cotización | NextAdmin</title>
...
?>
             ...
             <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/servicios/enviodecotizacion.php" class="nav-link active">
                 ...
                 <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="recibos.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Envio de Cotización</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Envio de Cotización</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Envio de Cotización</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                       <div class="card-body">  
              <form action="enviarcoti.php" method="post" enctype="multipart/form-data">
                <div class="form-row">
                  <!-- Forma de Envio de Orden --->
                    ...
                    <label for="niusuario">Cotización</label>
       ...
       <?php
                      ...
                      <option value="<?php echo $value['id'];?>"><?php echo 'NXT'.$value['id'].' '.$value['fecha'].' '.money_format('%(#10n',$value['total']).' - '.$value['cliente'];?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="correo" name="correo" placeholder="Introducir correo válido"  >
                  </div> 
