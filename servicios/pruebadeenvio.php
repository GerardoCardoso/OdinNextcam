<?php
// generando el pdf
//include 'pcoti.php'; //este archivo contiene el encabezado y pie de pagina del pdf
$var = 87;
...
$iva = array();
   ...
   $sql1="SELECT iva FROM cotizacion WHERE id = '$var'";
    $res1 = mysqli_query($con,$sql1);
    while($row1=mysqli_fetch_array($res1)){
      $iva[]=$row1['iva'];
    };
...
$mail->Subject = 'Cotizacion Nextcam '.date('m.d.y');
//$mail->Body = utf8_decode('Le hago llegar de manera adjunta la cotización solicitada.');
$mail->AddAddress('nextcamsoporte@gmail.com');
  $mail->Body    = $message;
 $mail->AltBody    = $message;
// definiendo el adjunto 
$mail->AddStringAttachment($doc, 'Cotizacion'.$var.'.pdf', 'base64', 'application/pdf');
