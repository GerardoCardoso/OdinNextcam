            ...
            <div class="card card-primary">
              ...
              <form action="altacotizacion.php" method="post" enctype="multipart/form-data">
                <div class="form-row">
                     ...
                     <p class="lead" align="center">Cotización No: <?php 
                           include("../conexion.php");                     
...
$clientes=$row[0];
               ...
               <?php
                    ...
                    <option value="<?php echo $result1[0]['id'];?>">
                         <?php echo $result1[0]['id'].' - '.$result1[0]['nombre']. ' '.$result1[0]['appaterno'];?>
                    </option>    
                    <?php
                    }?>
                       <option value=""></option>
       <?php
                      ...
                      <option value="<?php echo $value['id'];?>"><?php  echo $value['id'].' - '.$value['nombre'].' '.$value['appaterno'];?></option>
                      <?php
                      }
                      ?>
                    </select>
...
$fecha_actual = date("Y-m-d");
               ...
               <div class="form-group col-md-4">
                ...
                if(isset($result1)){?>
                    <input type="text"  class="form-control" id="envio" name="envio" value="<?php echo $result1[0]['mail'] ?>"  />
                <?php
                    
                }else{?>
                    <input type="text"  class="form-control" id="envio" name="envio" value="" />
                <?php
...
<!--<input type="text" class="form-control" id="envio" name="envio" placeholder="Introducir algun correo" >-->
  ...
  <input class="form-check-input" type="checkbox" value="" id="noaplica" name="noaplica" onclick="nin();multiplicar();"  checked >
  <label class="form-check-label" for="noaplica">
    NINGUNO
  </label><BR>
  <input class="form-check-input" type="checkbox" id="biva" name="biva" onclick="multiplicar();" value="1">
  <label class="form-check-label" for="biva">
    IVA
  </label><BR>
  <input class="form-check-input" type="checkbox" id="bdescuento" name="bdescuento" onclick="comprobardescuento();multiplicar();" value="1">
  <label class="form-check-label" for="bdescuento">
    DESCUENTO
  </label>
...
<!--  <label class="btn btn-outline-primary active">
    <input type="checkbox"  id="banticipio" name="banticipio" onchange="comprobaranticipo();" value="1"> ANTICIPO
  </label>-->
</div>
                  </div>
                </div>
...
$(".form-check-input").change(function() {
  var todosOn = $('.form-check-input:checked').length;
  if (!todosOn) {
     document.querySelectorAll('[name=noaplica]').forEach((x) => x.checked=true);
  }//SI TODOS LOS CEHCKBOX ESTAN DESELECCIONADOR EL CHEKBOX DE NO APLICAR
});
             
             function nin(){
                document.querySelectorAll('[name=biva]').forEach((x) => x.checked=false);
                document.querySelectorAll('[name=bdescuento]').forEach((x) => x.checked=false);
...
{   
  document.querySelectorAll('[name=noaplica]').forEach((x) => x.checked=false);
  ...
  <tr>
    ...
    <td style="width:150px;"><input type="text" class="form-control" id="descuento" name="descuento" onChange="multiplicar();" value="0.00" readonly/></td>
    ...
    <td style="width:150px;"><input type="text" class="form-control" id="anticipo" name="anticipo" onChange="multiplicar();" value="0" readonly/></td>
    ...
    <td style="width:150px;"><input type="text" class="form-control" id="ivat" name="ivat" value="0.00" readonly/></td>
...
function multiplicar(){
 ...
 // 	document.getElementById("total").value = total.toFixed(2);
   ...
   total=su1;
 document.getElementById("total").value = total.toFixed(2);
      if (document.getElementById("biva").checked){//SELECCIONAR IVA
 ...
 // document.getElementById("ivat").value = ivasu.toFixed(2);
   document.getElementById("ivat").value = ivasu.toFixed(2);
   total=su1-des;
 document.getElementById("total").value = total.toFixed(2);
  }
  
  if (document.getElementById("bdescuento").checked){ //SELECCIONAR DESCUENTO
   total=su1-des;
  	document.getElementById("total").value = total.toFixed(2);
   
}else{
  document.getElementById("descuento").value = dessu.toFixed(2);
   //iva=(su1*1.16)-su1;
   total=su1+iva;
  	document.getElementById("total").value = total.toFixed(2);
}
 ...
 document.getElementById("total").value = total.toFixed(2);
   ...
   if (document.getElementById("bdescuento").checked && document.getElementById("biva").checked){
