...
?>
          <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="cuentas.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <?php
    include("../conexion.php");                     
$cont="SELECT count(*) FROM cuentas";
...
for ($i=0; $i < $cuentas ; $i++) { 
$sql1="SELECT cuenta FROM cuentas";
    $res1 = mysqli_query($con,$sql1);
    while($row1=mysqli_fetch_array($res1)){
      $cuenta[]=$row1['cuenta'];
    };
    $sql2="SELECT url FROM cuentas";
    $res2 = mysqli_query($con,$sql2);
    while($row2=mysqli_fetch_array($res2)){
      $url[]=$row2['url'];
    };  
  $sql12="SELECT usuario FROM cuentas";
    $res12 = mysqli_query($con,$sql12);
    while($row12=mysqli_fetch_array($res12)){
      $usuario[]=$row12['usuario'];
    };  
    $sql3="SELECT contraseña FROM cuentas";
    $res3 = mysqli_query($con,$sql3);
    while($row3=mysqli_fetch_array($res3)){
      $contra[]=$row3['contraseña'];
    };
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Creción de cuentas</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card-body">
              <form action="altacuenta.php" method="post">
                <div class="form-row">
                  <div class="form-group  col-md-3">
                    <label for="cuenta">Cuenta</label>
                    <input type="text" class="form-control" id="cuenta" name="cuenta" placeholder="Introducir nombre de la cuenta" required>
                  </div>
                  <div class="form-group  col-md-3">
                    <label for="url">Url</label>
                    <input type="text" class="form-control" id="url" name="url" placeholder="Introducir URL" required>
                  </div>
                  <div class="form-group  col-md-3">
                  ...
                  <div class="form-group  col-md-3">
                    ...
                    <button class="btn btn-primary btn-xs" type="button" onclick="mostrarContrasena()">  <i class="nav-icon fas fa-eye"></i></button>
