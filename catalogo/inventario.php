...
<head>
  ...
  <title>Inventario | NextAdmin</title>
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
 ...
 include("../conexion.php");     
          ...
          <div class="form-group  col-md-4">
            ...
            <div class="form-group  col-md-4">
                ...
                <div class="form-group col-md-4" align="center">
                  <button id="bbusqueda" name="bbusqueda" type="submit" class="btn btn-primary">Buscar</button>
                </div>
            <div class="form-group  col-md-4">
          </div>
             </form>
  ...
  <?php
    ...
    if(isset($_POST['bbusqueda'])){
      $producto = $_POST['producto'];
               include("../conexion.php");                
$cont="SELECT sum(cantidad) FROM entradas where producto='$producto'";
$count = mysqli_query($con,$cont);
while($row=mysqli_fetch_array($count)){
$clientes=$row[0];
};
      
      $cont="SELECT sum(cantidad) FROM salidas where producto='$producto'";
$count = mysqli_query($con,$cont);
while($row=mysqli_fetch_array($count)){
$csalidas=$row[0];
};
      
$existencia = $clientes-$csalidas;
      echo "  <div class='row'>
        <div class='form-group  col-md-4' align='center'>
        <h1>Entradas</h1>
        <h>{$clientes}</h1>
