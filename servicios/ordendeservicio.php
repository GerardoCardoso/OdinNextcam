...
if(isset($_POST["boton"])){
  ...
  $idpass=$_POST['clave'];
  $sql1="SELECT orden FROM accesoservicio WHERE clave = '$idpass'";
  ...
  if($idpase!=NULL) {
    ...
    $cliente = array();
        ...
        $sql1="SELECT fecha FROM ordenservicio WHERE id = '$idos'";
        $res1 = mysqli_query($con,$sql1);
        while($row1=mysqli_fetch_array($res1)){
          $fecha[]=$row1['fecha'];
        };
        $sql1="SELECT cliente FROM ordenservicio WHERE id = '$idos'";
        $res1 = mysqli_query($con,$sql1);
        while($row1=mysqli_fetch_array($res1)){
          $cliente[]=$row1['cliente'];
        };

     $sql1="SELECT tecnico FROM ordenservicio WHERE id = '$idos'";
        $res1 = mysqli_query($con,$sql1);
        while($row1=mysqli_fetch_array($res1)){
    ...
    $token = strtok($nombret[0], " "); 
     $sql2="SELECT servicio FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $servicio[]=$row2['servicio'];
        };  

     $sql2="SELECT modelo FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $modelo[]=$row2['modelo'];
        }; 
     $sql2="SELECT caracterristicas FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $caracteristicas[]=$row2['caracterristicas'];
        }; 
     $sql2="SELECT noserie FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $noserie[]=$row2['noserie'];
        }; 
     $sql2="SELECT falla FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $falla[]=$row2['falla'];
        }; 
    $sql2="SELECT tipodeservicio FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $tipodeservicio[]=$row2['tipodeservicio'];
        }; 
    $sql2="SELECT observaciones FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $observaciones[]=$row2['observaciones'];
        }; 
    $sql2="SELECT firma FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $firma[]=$row2['firma'];
        }; 
    $sql2="SELECT costo FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $costo[]=$row2['costo'];
        }; 
    ...
    //----
    $sql2="SELECT dvro FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $uno[]=$row2['dvro'];
        };
    $sql2="SELECT coneco FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $dos[]=$row2['coneco'];
        };
    $sql2="SELECT reguladorf FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $tres[]=$row2['reguladorf'];
        };

    $sql2="SELECT camarasenfo FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $cuatro[]=$row2['camarasenfo'];
        };
    $sql2="SELECT voltajec FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $cinco[]=$row2['voltajec'];
        };
    $sql2="SELECT panelop FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $seis[]=$row2['panelop'];
        };
    $sql2="SELECT sensoresf FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $siete[]=$row2['sensoresf'];
        };
    $sql2="SELECT voltajeca FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $ocho[]=$row2['voltajeca'];
        };
    $sql2="SELECT conecoa FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $nueve[]=$row2['conecoa'];
        };

    $sql2="SELECT bfuncionando FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $diez[]=$row2['bfuncionando'];
        };
    $sql2="SELECT gpso FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $once[]=$row2['gpso'];
        };
    $sql2="SELECT voltajecg FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $doce[]=$row2['voltajecg'];
        };
    $sql2="SELECT conecog FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $trece[]=$row2['conecog'];
        };
    $sql2="SELECT cablesase FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $catorce[]=$row2['cablesase'];
        };
    $sql2="SELECT chipfuncional FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $quince[]=$row2['chipfuncional'];
        };
    $sql2="SELECT energizadoro FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $diezyseis[]=$row2['energizadoro'];
        };
    $sql2="SELECT hilosa FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $diezysiete[]=$row2['hilosa'];
        };
    $sql2="SELECT letreroscol FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $diezyocho[]=$row2['letreroscol'];
        };
    $sql2="SELECT cablebcon FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $diezynueve[]=$row2['cablebcon'];
        };
    $sql2="SELECT tierra FROM ordenservicio where id = '$idos'";
        $res2 = mysqli_query($con,$sql2);
        while($row2=mysqli_fetch_array($res2)){
          $veinte[]=$row2['tierra'];
        };
    ...
    $pdf->Ln(5);
    $pdf->SetFont('Arial','',10);
    $pdf->Cell(0,0,utf8_decode('NOMBRE DEL CLIENTE: '.strtoupper ( $nombre[0]).' '.strtoupper ( $apaterno[0]).''),0,1,'L');
    $pdf->Cell(0,0,utf8_decode('                   NO DE CLIENTE: '.$cliente[0].''),0,1,'C');
    ...
    $pdf->Cell(0,0,utf8_decode('NUMERO DE ORDEN: '.strtoupper ($idos).''),0,1,'R');
    $pdf->Ln(10);
    $pdf->SetFont('Arial','BU',10);
    ...
    $pdf->Ln(15);
    $pdf->Image($firma[0],20,235,22,22);
    ...
    $cont="SELECT count(*) FROM evidencias where orden= ' $idos'";
    ...
    if($evidencias>0&& $evidencias<=1){
      ...
      $sql1="SELECT ruta FROM evidencias where orden= ' $idos'";
        $res1 = mysqli_query($con,$sql1);
        while($row1=mysqli_fetch_array($res1)){
          $ruta[]=$row1['ruta'];
        };
      ...
      $pdf->Output('D','ORDEN DE SERVICIO.pdf');
   ...
   echo "<script type=\"text/javascript\">alert(\"No se encuentra ninguna orden de servicio ligada a su clave\");window.location = 'https://nextcam.com.mx/';</script>"; 
  
}
else
   echo "<script type=\"text/javascript\">alert(\"Visite nuestro sitio web\");window.location = 'https://nextcam.com.mx/';</script>";
